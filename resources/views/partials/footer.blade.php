<section class="info bg-fluid mt-4 pt-5 text-center">
    ...
    <section class="bg-fluid pb-3">
        <div class="credits container r">
            <div class="row d-flex flex-column flex-lg-row justify-content-between align-items-center pt-2">
                <div class="jm_logo p-2">
            ...
            {{-- SONO SEGNAPOSTI PER LE NOSTRE FOTO TONDE --}}
                <div class="credits-dream-team p-2">
