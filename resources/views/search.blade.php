    ...
    <div class="sx">
      ...
      <div class="bs-example apartment_searched m-4 rounded">
        ...
        <a href="{{route('apartment.show',['id' => $apartment->id])}}">        
          <div class="card card_apartment_search border_sponsor my-5 position-relative" data-lat="{{$apartment->latitude}}" data-lng="{{$apartment->longitude}}" data-id="{{$apartment->id}}"
              ...
              <div class="row no-gutters">
                  ...
                  <div class="col-lg-5 col-md-5 col-sm-5 d-flex flex-column justify-content-between">
                          ...
                          <ul class="list-inline ml-3 list-icon-card-search p-2">
                              <li class="list-inline-item"><i class="fas fa-bed item-sponsored"></i> {{$apartment->n_beds}}</li>
                              <li class="list-inline-item"><i class="fas fa-door-open item-sponsored"></i> {{$apartment->n_rooms}}</li>
                              <li class="list-inline-item"><i class="fas fa-toilet item-sponsored"></i> {{$apartment->n_bathrooms}}</li>
                          </ul>
        ...
        @endforeach
          ...
          @foreach ($apartments as $apartment)
            ...
            <a href="{{route('apartment.show',['id' => $apartment->id])}}">
              <div class="card card_apartment_search border_apartment my-5" data-lat="{{$apartment->latitude}}" data-lng="{{$apartment->longitude}}" data-id="{{$apartment->id}}"
                data-img="{{$apartment->cover->imgurl}}"
                data-title="{{$apartment->title}}" data-description="{{$apartment->description}}" data-address="{{$apartment->address}}" data-beds="{{$apartment->n_beds}}" data-rooms="{{$apartment->n_rooms}}" data-bathrooms="{{$apartment->n_bathrooms}}">
                  <div class="row no-gutters">
                      <div class="card-img-search col-lg-7 col-md-7 col-sm-7 card-img-top img-fluid" style="background-image: url('{{$apartment->cover->imgurl}}')">
...
<script id="template" type="text/x-handlebars-template">
    <a href="http://localhost:8000/apartments/show/@{{id}}">
      <div class="card card_apartment_search border_apartment my-5" data-lat="@{{latitude}}" data-lng="@{{longitude}}" data-id="@{{id}}">
          <div class="row no-gutters">
